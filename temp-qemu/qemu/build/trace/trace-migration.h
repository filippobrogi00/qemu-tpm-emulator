...
#line 42 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:savevm_send_switchover_start " "" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     );
...
#line 10364 "trace/trace-migration.h"
        }
    }
}
...
#line 10395 "trace/trace-migration.h"
        }
    }
}
...
#line 10426 "trace/trace-migration.h"
        }
    }
}
...
#line 10457 "trace/trace-migration.h"
        }
    }
}
...
#line 10488 "trace/trace-migration.h"
        }
    }
}
...
#line 10519 "trace/trace-migration.h"
        }
    }
}
...
#line 10550 "trace/trace-migration.h"
        }
    }
}
...
#line 10581 "trace/trace-migration.h"
        }
    }
}
...
#line 10612 "trace/trace-migration.h"
        }
    }
}
...
#line 10643 "trace/trace-migration.h"
        }
    }
}
...
#line 10674 "trace/trace-migration.h"
        }
    }
}
...
#line 10705 "trace/trace-migration.h"
        }
    }
}
...
#line 10736 "trace/trace-migration.h"
        }
    }
}
...
#line 10767 "trace/trace-migration.h"
        }
    }
}
...
#line 10798 "trace/trace-migration.h"
        }
    }
}
...
#line 10829 "trace/trace-migration.h"
        }
    }
}
...
#line 10860 "trace/trace-migration.h"
        }
    }
}
...
#line 10891 "trace/trace-migration.h"
        }
    }
}
...
#line 10922 "trace/trace-migration.h"
        }
    }
}
...
#line 10953 "trace/trace-migration.h"
        }
    }
}
...
#line 367 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:dirty_bitmap_load_header " "flags 0x%x" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , flags);
#line 10980 "trace/trace-migration.h"
        } else {
#line 367 "../migration/trace-events"
            qemu_log("dirty_bitmap_load_header " "flags 0x%x" "\n", flags);
#line 10984 "trace/trace-migration.h"
        }
    }
}
...
#line 11011 "trace/trace-migration.h"
        } else {
#line 368 "../migration/trace-events"
            qemu_log("dirty_bitmap_load_enter " "" "\n");
#line 11015 "trace/trace-migration.h"
        }
    }
}
...
#line 11042 "trace/trace-migration.h"
        } else {
#line 369 "../migration/trace-events"
            qemu_log("dirty_bitmap_load_success " "" "\n");
#line 11046 "trace/trace-migration.h"
        }
    }
}
...
#line 372 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:dirtyrate_set_state " "new state %s" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , new_state);
#line 11073 "trace/trace-migration.h"
        } else {
#line 372 "../migration/trace-events"
            qemu_log("dirtyrate_set_state " "new state %s" "\n", new_state);
#line 11077 "trace/trace-migration.h"
        }
    }
}
...
#line 373 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:query_dirty_rate_info " "current state %s" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , new_state);
#line 11104 "trace/trace-migration.h"
        } else {
#line 373 "../migration/trace-events"
            qemu_log("query_dirty_rate_info " "current state %s" "\n", new_state);
#line 11108 "trace/trace-migration.h"
        }
    }
}
...
#line 376 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:skip_sample_ramblock " "ramblock name: %s, ramblock size: %" PRIu64 "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , idstr, ramblock_size);
#line 11197 "trace/trace-migration.h"
        } else {
#line 376 "../migration/trace-events"
            qemu_log("skip_sample_ramblock " "ramblock name: %s, ramblock size: %" PRIu64 "\n", idstr, ramblock_size);
#line 11201 "trace/trace-migration.h"
        }
    }
}
...
#line 377 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:find_page_matched " "ramblock %s addr or size changed" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , idstr);
#line 11228 "trace/trace-migration.h"
        } else {
#line 377 "../migration/trace-events"
            qemu_log("find_page_matched " "ramblock %s addr or size changed" "\n", idstr);
#line 11232 "trace/trace-migration.h"
        }
    }
}
...
#line 378 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:dirtyrate_calculate " "dirty rate: %" PRIi64 " MB/s" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , dirtyrate);
#line 11259 "trace/trace-migration.h"
        } else {
#line 378 "../migration/trace-events"
            qemu_log("dirtyrate_calculate " "dirty rate: %" PRIi64 " MB/s" "\n", dirtyrate);
#line 11263 "trace/trace-migration.h"
        }
    }
}
...
#line 379 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:dirtyrate_do_calculate_vcpu " "vcpu[%d]: %"PRIu64 " MB/s" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , idx, rate);
#line 11290 "trace/trace-migration.h"
        } else {
#line 379 "../migration/trace-events"
            qemu_log("dirtyrate_do_calculate_vcpu " "vcpu[%d]: %"PRIu64 " MB/s" "\n", idx, rate);
#line 11294 "trace/trace-migration.h"
        }
    }
}
...
#line 383 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:migration_block_init_full " "Start full migration for %s" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , blk_device_name);
#line 11352 "trace/trace-migration.h"
        } else {
#line 383 "../migration/trace-events"
            qemu_log("migration_block_init_full " "Start full migration for %s" "\n", blk_device_name);
#line 11356 "trace/trace-migration.h"
        }
    }
}
...
#line 11476 "trace/trace-migration.h"
        } else {
#line 387 "../migration/trace-events"
            qemu_log("migration_block_save_complete " "Block migration completed" "\n");
#line 11480 "trace/trace-migration.h"
        }
    }
}
...
#line 389 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:migration_block_progression " "Completed %u%%" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , percent);
#line 11538 "trace/trace-migration.h"
        } else {
#line 389 "../migration/trace-events"
            qemu_log("migration_block_progression " "Completed %u%%" "\n", percent);
#line 11542 "trace/trace-migration.h"
        }
    }
}
...
#line 392 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:migration_pagecache_init " "Setting cache buckets to %" PRId64 "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , max_num_items);
#line 11569 "trace/trace-migration.h"
        } else {
#line 392 "../migration/trace-events"
            qemu_log("migration_pagecache_init " "Setting cache buckets to %" PRId64 "\n", max_num_items);
#line 11573 "trace/trace-migration.h"
        }
    }
}
...
#line 11600 "trace/trace-migration.h"
        } else {
#line 393 "../migration/trace-events"
            qemu_log("migration_pagecache_insert " "Error allocating page" "\n");
#line 11604 "trace/trace-migration.h"
        }
    }
}
...
#line 396 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:cpu_throttle_set " "set guest CPU throttled by %d%%" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , new_throttle_pct);
#line 11631 "trace/trace-migration.h"
        } else {
#line 396 "../migration/trace-events"
            qemu_log("cpu_throttle_set " "set guest CPU throttled by %d%%" "\n", new_throttle_pct);
#line 11635 "trace/trace-migration.h"
        }
    }
}
...
#line 11662 "trace/trace-migration.h"
        } else {
#line 397 "../migration/trace-events"
            qemu_log("cpu_throttle_dirty_sync " "" "\n");
#line 11666 "trace/trace-migration.h"
        }
    }
}
...
#line 400 "../migration/trace-events"
            qemu_log("%d@%zu.%06zu:migration_block_activation " "%s" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , name);
#line 11693 "trace/trace-migration.h"
        } else {
#line 400 "../migration/trace-events"
            qemu_log("migration_block_activation " "%s" "\n", name);
#line 11697 "trace/trace-migration.h"
        }
    }
}
