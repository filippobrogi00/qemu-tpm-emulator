...
#line 4 "../hw/pci/trace-events"
            qemu_log("%d@%zu.%06zu:pci_pm_bad_transition " "%s %02x:%02x.%x REJECTED PM transition D%d->D%d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , dev, bus, slot, func, old, new);
#line 67 "trace/trace-hw_pci.h"
        } else {
#line 4 "../hw/pci/trace-events"
            qemu_log("pci_pm_bad_transition " "%s %02x:%02x.%x REJECTED PM transition D%d->D%d" "\n", dev, bus, slot, func, old, new);
#line 71 "trace/trace-hw_pci.h"
        }
    }
}
...
#line 5 "../hw/pci/trace-events"
            qemu_log("%d@%zu.%06zu:pci_pm_transition " "%s %02x:%02x.%x PM transition D%d->D%d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , dev, bus, slot, func, old, new);
#line 98 "trace/trace-hw_pci.h"
        } else {
#line 5 "../hw/pci/trace-events"
            qemu_log("pci_pm_transition " "%s %02x:%02x.%x PM transition D%d->D%d" "\n", dev, bus, slot, func, old, new);
#line 102 "trace/trace-hw_pci.h"
        }
    }
}
...
#line 191 "trace/trace-hw_pci.h"
        } else {
#line 8 "../hw/pci/trace-events"
            qemu_log("pci_route_irq " "IRQ %d @%s -> IRQ %d @%s" "\n", dev_irq, dev_path, parent_irq, parent_path);
#line 195 "trace/trace-hw_pci.h"
        }
    }
}
...
#line 222 "trace/trace-hw_pci.h"
        } else {
#line 11 "../hw/pci/trace-events"
            qemu_log("pci_cfg_read " "%s %02x:%02x.%x @0x%x -> 0x%x" "\n", dev, bus, slot, func, offs, val);
#line 226 "trace/trace-hw_pci.h"
        }
    }
}
...
#line 12 "../hw/pci/trace-events"
            qemu_log("%d@%zu.%06zu:pci_cfg_write " "%s %02x:%02x.%x @0x%x <- 0x%x" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , dev, bus, slot, func, offs, val);
#line 253 "trace/trace-hw_pci.h"
        } else {
#line 12 "../hw/pci/trace-events"
            qemu_log("pci_cfg_write " "%s %02x:%02x.%x @0x%x <- 0x%x" "\n", dev, bus, slot, func, offs, val);
#line 257 "trace/trace-hw_pci.h"
        }
    }
}
...
#line 315 "trace/trace-hw_pci.h"
        } else {
#line 18 "../hw/pci/trace-events"
            qemu_log("sriov_register_vfs " "%s %02x:%x: creating %d vf devs" "\n", name, slot, function, num_vfs);
#line 319 "trace/trace-hw_pci.h"
        }
    }
}
...
#line 439 "trace/trace-hw_pci.h"
        } else {
#line 26 "../hw/pci/trace-events"
            qemu_log("shpc_slot_command " "%s[%d] > %s: pic: %s->%s, aic: %s->%s, state: %s->%s" "\n", parent, pci_slot, child, old_pic, new_pic, old_aic, new_aic, old_state, new_state);
#line 443 "trace/trace-hw_pci.h"
        }
    }
}
