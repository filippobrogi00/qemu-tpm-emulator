...
#line 5 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:exec_tb " "tb:%p pc=0x%"PRIxPTR "\n",
                     ...
                     , tb, pc);
#line 76 "trace/trace-accel_tcg.h"
        } else {
#line 5 "../accel/tcg/trace-events"
            qemu_log("exec_tb " "tb:%p pc=0x%"PRIxPTR "\n", tb, pc);
#line 80 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 111 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 7 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:exec_tb_exit " "tb:%p flags=0x%x" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , last_tb, flags);
#line 138 "trace/trace-accel_tcg.h"
        } else {
#line 7 "../accel/tcg/trace-events"
            qemu_log("exec_tb_exit " "tb:%p flags=0x%x" "\n", last_tb, flags);
#line 142 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 173 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 11 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:memory_notdirty_set_dirty " "0x%" PRIx64 "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , vaddr);
#line 200 "trace/trace-accel_tcg.h"
        } else {
#line 11 "../accel/tcg/trace-events"
            qemu_log("memory_notdirty_set_dirty " "0x%" PRIx64 "\n", vaddr);
#line 204 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 14 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:translate_block " "tb:%p, pc:0x%"PRIxPTR", tb_code:%p" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , tb, pc, tb_code);
#line 231 "trace/trace-accel_tcg.h"
        } else {
#line 14 "../accel/tcg/trace-events"
            qemu_log("translate_block " "tb:%p, pc:0x%"PRIxPTR", tb_code:%p" "\n", tb, pc, tb_code);
#line 235 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 17 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:load_atom2_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , memop, ra);
#line 262 "trace/trace-accel_tcg.h"
        } else {
#line 17 "../accel/tcg/trace-events"
            qemu_log("load_atom2_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n", memop, ra);
#line 266 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 18 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:load_atom4_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , memop, ra);
#line 293 "trace/trace-accel_tcg.h"
        } else {
#line 18 "../accel/tcg/trace-events"
            qemu_log("load_atom4_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n", memop, ra);
#line 297 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 19 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:load_atom8_or_exit_fallback " "ra:0x%"PRIxPTR"" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , ra);
#line 324 "trace/trace-accel_tcg.h"
        } else {
#line 19 "../accel/tcg/trace-events"
            qemu_log("load_atom8_or_exit_fallback " "ra:0x%"PRIxPTR"" "\n", ra);
#line 328 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 20 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:load_atom8_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , memop, ra);
#line 355 "trace/trace-accel_tcg.h"
        } else {
#line 20 "../accel/tcg/trace-events"
            qemu_log("load_atom8_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n", memop, ra);
#line 359 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 21 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:load_atom16_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , memop, ra);
#line 386 "trace/trace-accel_tcg.h"
        } else {
#line 21 "../accel/tcg/trace-events"
            qemu_log("load_atom16_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n", memop, ra);
#line 390 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 22 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:load_atom16_or_exit_fallback " "ra:0x%"PRIxPTR"" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , ra);
#line 417 "trace/trace-accel_tcg.h"
        } else {
#line 22 "../accel/tcg/trace-events"
            qemu_log("load_atom16_or_exit_fallback " "ra:0x%"PRIxPTR"" "\n", ra);
#line 421 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 23 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:store_atom2_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , memop, ra);
#line 448 "trace/trace-accel_tcg.h"
        } else {
#line 23 "../accel/tcg/trace-events"
            qemu_log("store_atom2_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n", memop, ra);
#line 452 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 24 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:store_atom4_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , memop, ra);
#line 479 "trace/trace-accel_tcg.h"
        } else {
#line 24 "../accel/tcg/trace-events"
            qemu_log("store_atom4_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n", memop, ra);
#line 483 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 25 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:store_atom8_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , memop, ra);
#line 510 "trace/trace-accel_tcg.h"
        } else {
#line 25 "../accel/tcg/trace-events"
            qemu_log("store_atom8_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n", memop, ra);
#line 514 "trace/trace-accel_tcg.h"
        }
    }
}
...
#line 26 "../accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:store_atom16_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , memop, ra);
#line 541 "trace/trace-accel_tcg.h"
        } else {
#line 26 "../accel/tcg/trace-events"
            qemu_log("store_atom16_fallback " "mop:0x%"PRIx32", ra:0x%"PRIxPTR"" "\n", memop, ra);
#line 545 "trace/trace-accel_tcg.h"
        }
    }
}
