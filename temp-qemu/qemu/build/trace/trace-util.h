...
#line 17 "../util/trace-events"
            qemu_log("%d@%zu.%06zu:thread_pool_submit_aio " "pool %p req %p opaque %p" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , pool, req, opaque);
...
#line 18 "../util/trace-events"
            qemu_log("%d@%zu.%06zu:thread_pool_complete_aio " "pool %p req %p opaque %p ret %d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , pool, req, opaque, ret);
...
#line 19 "../util/trace-events"
            qemu_log("%d@%zu.%06zu:thread_pool_cancel_aio " "req %p opaque %p" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , req, opaque);
